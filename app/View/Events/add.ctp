...
<div class="form-horizontal" style="padding: 2em">
    ...
    <div class="control-group">
        ...
        <div class="controls">
            <?php echo $this->Form->input('e_order_num', array('type' => 'number', 'id' => 'inputOrder', 'min' => 0 ,'placeholder' => '8888', 'label' => FALSE));
            ?>
        </div>
    </div>
    ...
    <div class="control-group">
        ...
        <div class="controls">
            <?php echo $this->Form->input('event_category_id', array('type' => 'select', 'id' => 'inputCat', 'placeholder' => 'Birthday', 'options' => array($event_categories), 'label' => FALSE));
            ?>
        </div>
    </div>
    ...
    <div class="control-group">
        ...
        <div class="controls">
            <?php echo $this->Form->input('e_sub_category', array('type' => 'text', 'id' => 'inputSubCat', 'placeholder' => 'Dinner', 'label' => FALSE));
            ?>
        </div>
    </div>
    ...
    <div class="control-group">
        ...
        <div class="controls">
            <?php echo $this->Form->input('e_num_males_attend', array('type' => 'number', 'id' => 'inputMale', 'min' => 0, 'placeholder' => '12', 'label' => FALSE));
            ?>
        </div>
    </div>
    ...
    <div class="control-group">
        ...
        <div class="controls">
            <?php echo $this->Form->input('e_num_females_attend', array('type' => 'number', 'id' => 'inputFemale', 'min' => 0, 'placeholder' => '12', 'label' => FALSE));
            ?>
        </div>
    </div>
    ...
    <div class="control-group">
        ...
        <div class="controls">
            <?php echo $this->Form->input('e_drinks_package', array('type' => 'text', 'id' => 'inputPack', 'placeholder' => 'B', 'label' => FALSE));
            ?>
        </div>
    </div>
    ...
    <div class="control-group">
        ...
        <div class="controls">
            <?php echo $this->Form->input('e_bar_facilities', array('type' => 'text', 'id' => 'inputBar', 'placeholder' => 'Set A', 'label' => FALSE));
            ?>
        </div>
    </div>
